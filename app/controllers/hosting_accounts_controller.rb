class HostingAccountsController < ApplicationController
  ...
  def hosting_account_params
    params.require(:hosting_account).permit(:annual_fee, :backed_up_on, :backup_cycle, :domain_id, :expected_http_status_code, :ftp_host, :host_name, :password, :started_on, :username)
  end
end
